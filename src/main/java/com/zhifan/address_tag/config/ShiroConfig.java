...
import com.zhifan.address_tag.shiro.JwtFilter;
import com.zhifan.address_tag.shiro.MyRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
        filterChainDefinitionMap.put("/al/account/login", "anon");
        filterChainDefinitionMap.put("/al/account/register", "anon");
        filterChainDefinitionMap.put("/al/*", "anon");
